...
export function buildRegionSeo({ countrySlug = '', regionSlug = '', resolvedSlugData = {} } = {}) {
    ...
    const metaTitle = getFirstDefinedString(resolvedSlugData?.metaTitle, resolvedSlugData?.name, defaultTitle) || defaultTitle;
...
export function buildCountrySeo({ countrySlug = '', resolvedSlugData = {} } = {}) {
    ...
    const metaDescription = normalizeText(getFirstDefinedString(resolvedSlugData?.metaDescription));
...
export function buildCitySeo({ citySlug = '', resolvedSlugData = {}, firstHotel = {}, countryName = '', countrySlug = '' } = {}) {
    ...
    const metaTitle = getFirstDefinedString(resolvedSlugData?.metaTitle) || defaultTitle;
