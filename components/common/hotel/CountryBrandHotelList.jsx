...
export default function CountryBrandHotelList({ hotels = [], brand }) {
                                ...
                                <div key={city.cityName}>
                                    ...
                                    <Link href={getCityBrandPath(city.cityUrlName)} className="text-decoration-none">
                                        <h5 className="text-warning city-hover">
                                            {brand.replace(/-/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase())} {city.cityName}
                                        </h5>
                                    </Link>
                                                    ...
                                                    >
                                                        ...
                                                        <div className="d-flex align-items-center justify-content-between mb-2">
                                                            <div className="d-flex align-items-center">
                                                                <h4 className="property-grid-title font-size-18 my-auto me-3">
                                                                    {hotel.hotelName}
                                                                </h4>
                                                        ...
                                                        <p className="para-12px mb-0 text-theme-green">
                                                            <i className="fa-solid fa-check me-1"></i>
                                                            <b>Free Cancellation</b>
                                                        </p>

                                                        <p className="para-12px mb-1 text-theme-green">
                                                            <i className="fa-solid fa-check me-1"></i>
                                                            No Payment Needed
                                                        </p>
